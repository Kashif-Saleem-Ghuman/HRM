      ...
      <div id="directory-wrapper">
        <div class="" id="tab_info_wrapper">
          <div v-if="activeTab == timeOffTab[0].value">
            ...
            <list-my-timeoff :timeoffData="timeoffData"></list-my-timeoff>
          </div>
          <div v-if="activeTab == timeOffTab[1].value">
            ...
            <list-my-request :timeoffData="timeoffRequestData"></list-my-request>
          </div>
        </div>
      </div>
    </div>
...
import { MY_TIMEOFF_DATA, TIMEOFF_REQUEST_DATA } from "../../utils/constant/TimesheetData.js";
import { mapGetters } from "vuex";
export default {
  data() {
    return {
      id: "",
      timeOffTab: MY_TIME_OFF_TAB,
      timeoffData: MY_TIMEOFF_DATA,
