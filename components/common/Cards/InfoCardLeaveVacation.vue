      ...
      <div class="info-card-leave-wrapper" style="width: 100%">
        ...
        <div class="info-card-items mt-05">
          <div>
            ...
            <span>{{ item.allowance - item.used  == Nan ? item.allowance - item.used : '00' }}</span>
        ...
        <div class="button-wrapper" :class="className" @click.stop="$emit('on-click')">
