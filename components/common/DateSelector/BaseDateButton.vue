...
export default {
  ...
  methods: {
    setDefaultValue() {
      throw new Error(
        "Set default value needs to be implemented in extended component"
      );
    },
    toggleDropdown() {
...
.dropdown-button {
  ...
  min-width: $date-btn-width;
  max-height: $date-btn-height;
...
.dropdown-menu {
  width: $date-btn-width;
  min-height: $date-btn-height;
