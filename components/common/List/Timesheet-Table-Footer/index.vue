  ...
  <div class="table-footer">
    ...
    <div class="footer-items" v-if="showStatus">
      ...
      <div class="footer-item-right">
        ...
        <leave-status v-else :leaveStatusData="status"   @click="buttonClicked" :buttonVarintChange="true"></leave-status>
    ...
    <div class="footer-items bottom-border-remove" v-else>
      ...
      <div class="footer-item-right d-flex align-center">
        ...
        <leave-status v-else :leaveStatusData="status" :timesheet="true"  @click="buttonClicked" :buttonVarintChange="true"></leave-status>
