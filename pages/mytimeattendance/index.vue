      ...
      <div id="directory-wrapper">
        <div class="" id="tab_info_wrapper">
          <div v-if="activeTab == myTimeAttendanceTab[0].value">
            ...
            <list-my-timesheet :timeoffData="timeoffData"></list-my-timesheet>
          </div>
          <div v-if="activeTab == myTimeAttendanceTab[1].value">
            <div
              class="d-flex justify-between align-center nav_wrapper px-075 bottom_border_wrapper"
            >
              <div class="d-flex align-center">
            ...
            <list-pending-my-attendance
              :timeoffData="timeoffRequestData"
            ></list-pending-my-attendance>
          </div>
        </div>
      </div>
...
export default {
  data() {
    return {
      id: "",
      myTimeAttendanceTab: MY_TIME_ATTENDANCE,
      timeoffData: MY_TIMESHEET_DATA,
      timeoffRequestData: TIMEOFF_REQUEST_DATA,
      activeTab: "Dashborad",
      items: MORE_MENU,
      actionMenu: SORTING_MENU.actionMenuTimesheet,
      orderBy: "asc",
      totalUser: "",
